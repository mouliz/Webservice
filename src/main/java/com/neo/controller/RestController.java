...
import com.neo.domain.Status;
import com.neo.service.DataServices;
...
public class RestController {  
 ...
 public @ResponseBody Status updateEmployee(@PathVariable("id") long id)
 {
	
	 try {  
		   dataServices.updateEntity(id) ;  
